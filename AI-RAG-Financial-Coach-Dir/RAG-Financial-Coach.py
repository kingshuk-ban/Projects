...
query = "What is your name and why should I trust you?"
...
messages = [
    SystemMessage(content="You are a helpful financial coach named Kingshuk. \
                  Your client will ask you questions about your service.\
